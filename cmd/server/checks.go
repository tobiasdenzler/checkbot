...
type Check struct {
	...
	Help              string
	metric            interface{}
	dimensionsLast    map[string]map[string]string // Metric dimensions of the last run
	dimensionsCurrent map[string]map[string]string // Metric dimensions of the current run
		...
		if info != nil && !info.IsDir() {
			...
			if !strings.Contains(path, "..") {
				...
				check = &Check{
					...
					dimensionsLast:    map[string]map[string]string{},
					dimensionsCurrent: map[string]map[string]string{},
